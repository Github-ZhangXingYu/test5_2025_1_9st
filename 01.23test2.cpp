...
//
//    Task(QString name,QString endTime,QString stNode);
//    void clear();//清空
//    void addNode(QString node);//添加途经点
//    QString show();//展示
};
...
signed main() {
//    std::ifstream input_file("902.txt");
...
//    output_file << _n << std::endl;
    ...
    path_algorithm::Add_edge(2, 3, "bus_step", "school", 2, 24 * 3600);
    path_algorithm::Add_edge(1, 2, "home", "bus_step", 3, 600);
    path_algorithm::Add_edge(1, 3, "home", "school", 1, 10);
